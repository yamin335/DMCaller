...
public class TextDrawable extends Drawable implements TextWatcher {
     ...
     * @param bindToViewsPaint Should this drawable mirror changes to Paint in the TextView, like
     *     textColor, typeface, alpha etc. Note, this will override any changes made using
     *     setColorFilter or setAlpha.
     */
    public TextDrawable(
            TextView tv, String initialText, boolean bindToViewsText, boolean bindToViewsPaint) {
     ...
     * Text and the Paint properties, however it will from that point on be independant of the
     * TextView.
     *
    ...
    /**
     * Use the provided TextView/EditText to initialize the drawable. The Drawable will copy the
     * Paint properties, and use the provided text to initialise itself.
     *
     * @param tv a TextView or EditText or any of their children.
     ...
     *
     * <p>Note: While this option will not work if bindToViewPaint is true.
     *
     * @param fitText
     */
