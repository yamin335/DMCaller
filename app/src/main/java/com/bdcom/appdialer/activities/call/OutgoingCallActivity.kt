 ...
 */
package com.bdcom.appdialer.activities.call
...
import com.bdcom.appdialer.activities.call.viewmodels.CallViewModel
import com.bdcom.appdialer.activities.call.viewmodels.CallViewModelFactory
import com.bdcom.appdialer.activities.call.viewmodels.ControlsViewModel
import com.bdcom.appdialer.databinding.CallOutgoingActivityBinding
    ...
    private fun initNumpadLayout() {
        ...
        numpadAnimator = ValueAnimator.ofFloat(screenWidth, 0f).apply {
            addUpdateListener {
                ...
                findViewById<LinearLayout>(R.id.numpad)?.translationX = -value
                duration = if (com.bdcom.appdialer.LinphoneApplication.corePreferences.enableAnimations) 500 else 0
            }
        }
        ...
        if (controlsViewModel.numpadVisibility.value == false) {
            findViewById<LinearLayout>(R.id.numpad)?.translationX = -screenWidth
        }
    }
}
