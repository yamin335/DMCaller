...
import com.bdcom.appdialer.contact.GenericContactViewModel
...
open class CallViewModel(val call: Call) : GenericContactViewModel(call.remoteAddress) {
    ...
    val contactName: String by lazy {
        ...
        AppUtils.getContactName(displayName)
//        val displayName = LinphoneUtils.getDisplayName(call.remoteAddress)
//        AppUtils.getContactName(AppUtils.getMobileNumber(address), displayName)
    }

    val callNumber: String by lazy {
